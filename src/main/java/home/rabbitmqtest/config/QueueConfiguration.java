...
public class QueueConfiguration {
	...
	@Autowired
	private List<QueueMessageManager> queueMessageManagers;
	@Autowired
	...
	private void migrationFailedMessagesListener(MigrateFailedMessagesListener messageListener, String ...queueNames) {
		BeanDefinitionRegistry beanDefinitionRegistry = (BeanDefinitionRegistry)context.getAutowireCapableBeanFactory();
	...
	public SimpleMessageListenerContainer messageListenerContainer(List<QueueMessageManager> processors, MessageConsumer messageConsumer) {
		String[] queueNames = processors.stream().map(QueueMessageManager::fromQueueName).toArray(String[]::new);
